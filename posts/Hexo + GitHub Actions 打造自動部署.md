...
但是很快地，過了大約一年左右便很少更新：**為什麼會這樣呢？**
終歸一句當然還是懶啦。

主要是靜態網頁的佈署步驟太麻煩，必須滿足本地端有 Hexo 檔案的前提，我偏偏又喜歡用 [HackMD](https://hackmd.io/) 撰寫，一來一往之間步驟太過繁複。

久而久之，這段時間我傾向於使用 HackMD 整理個人筆記，懶得發表技術文章到 blog 上。
